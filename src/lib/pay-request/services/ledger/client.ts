...
import { SearchResponse, TransactionType, ResourceType, PaymentProvider, App } from '../../shared'
...
export default class Ledger extends Client {
  ...
  payments = ((client: Ledger) => ({
     ...
     */
    listRefunds(id: string, params: ListPaymentRefundsRequest): Promise<ListPaymentRefundsResponse> {
      return client._axios
  ...
  transactions = ((client: Ledger) => ({
    ...
    retrieveRelatedTransactions(
      id: string,
      params: RelatedTransactionsRequest
    ): Promise<TransactionsForTransactionResponse> {
      return client._axios
     ...
     */
    listEvents(id: string, params: ListTransactionEventsRequest): Promise<ListTransactionEventsResponse> {
      return client._axios
  ...
  agreements = ((client: Ledger) => ({
    ...
    ): Promise<SearchResponse<Agreement>> {
      return client._axios
     ...
     *            transaction set as their parent transaction
     */
    listEvents(id: string, params: ListAgreementEventsRequest): Promise<ListAgreementEventsResponse> {
      return client._axios
  ...
  events = ((client: Ledger) => ({
     ...
     * @param params
     */
    listTicker(params: ListEventTickerRequest): Promise<EventTicker[]> {
      return (
        client._axios
  ...
  reports = ((client: Ledger) => ({
    retrievePaymentSummaryByState(
      params: PaymentsByStateWithAccountOverrideRequest | PaymentsByStateForAccountRequest
    ): Promise<PaymentCountByStateReport> {
      return client._axios
    ...
    retrieveTransactionSummary(
      params: TransactionSummaryWithAccountOverrideRequest | TransactionSummaryForAccountRequest
     ...
     */
    listTransactionSummaryByHour(params: TransactionsByHourRequest): Promise<TransactionsByHourReport> {
      return client._axios
        .get('/v1/report/transactions-by-hour', { params })
        .then((response) => client._unpackResponseData<TransactionsByHourReport>(response))
    },

    retrievePerformanceSummary(params: PerformanceReportRequest): Promise<PerformanceReport> {
      return client._axios
        .get('/v1/report/performance-report', { params })
        .then((response) => client._unpackResponseData<PerformanceReport>(response))
    },

    retrieveLegacyPerformanceSummary(params: PerformanceReportRequest): Promise<PerformanceReport> {
      return client._axios
        .get('/v1/report/performance-report-legacy', { params })
        .then((response) => client._unpackResponseData<PerformanceReport>(response))
    },

    retrievePerformanceSummaryByGateway(params: GatewayPerformanceReportRequest): Promise<GatewayPerformanceReport> {
      return client._axios
  ...
  payouts = ((client: Ledger) => ({
    list(params: ListPayoutForAccountRequest | ListPayoutWithAccountOverrideRequest): Promise<SearchResponse<Payout>> {
      const payoutParams = {
        ...params,
        ...(params.gateway_account_id &&
          Array.isArray(params.gateway_account_id) && { gateway_account_id: params.gateway_account_id.join(',') }),
      }
