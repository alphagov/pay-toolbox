...
router.get('/gateway_accounts/:id/disable', auth.secured, auth.administrative, gatewayAccounts.disableReasonPage)
router.post('/gateway_accounts/:id/disable', auth.secured, auth.administrative, gatewayAccounts.disable)
router.post('/gateway_accounts/:id/enable', auth.secured, auth.administrative, gatewayAccounts.enable)
...
router.post('/payment_links/:id/toggle_new_payment_link_journey_enabled', auth.secured, paymentLinks.toggleNewPaymentLinkJourneyEnabled)
