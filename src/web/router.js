...
router.get('/services/:id/branding-legacy', auth.secured, services.brandingLegacy, services.detail.exceptions)
router.post('/services/:id/branding-legacy', auth.secured, auth.administrative, services.updateBrandingLegacy)
router.get('/services/:id/branding', auth.secured, services.branding, services.detail.exceptions)
router.post('/services/:id/branding', auth.secured, upload.single('custom-branding-image'), services.updateBranding)
